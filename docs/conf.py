...
# -*- coding: utf-8 -*-
#
# uitcheckgemistlib documentation build configuration file, created by
# sphinx-quickstart
#
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'),
                   os.path.join(project_root, '''uitcheckgemistlib''')])
...
version = uitcheckgemistlib.__version__
# The full version, including alpha/beta/rc tags.
release = uitcheckgemistlib.__version__
...
htmlhelp_basename = '''uitcheckgemistlibdoc'''
...
# [howto/manual]).
latex_documents = [
    ('index', '''uitcheckgemistlib.tex''',
     u'''uitcheckgemistlib Documentation''',
